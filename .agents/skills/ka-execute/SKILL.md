...
```
Run these evals with `Codex-with-access-to-the-skill` (or the internal harness). The skill‑creator workflow will verify that the output contains the expected substring.
